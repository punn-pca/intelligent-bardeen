...
import { Truck, Plus, Search, Edit2, Trash2, CheckCircle2, AlertCircle, Building2 } from 'lucide-react';
  ...
  const handleCorporateLookup = async () => {
    ...
    try {
      ...
      setFormData((prev) => ({
        ...
        code: prev.code || `SUP-${corp.taxId.slice(-6)}`,
      }));
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5">
        ...
        {canEdit && (
          ...
          >
            ...
            <span>+ เพิ่มซัพพลายเออร์ใหม่ (Add Supplier)</span>
          </button>
        )}
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-xl p-6 space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-2">
                ...
                >
                  {editingId ? 'บันทึกการแก้ไข' : 'บันทึกซัพพลายเออร์'}
                </button>
              </div>
            </form>
          </div>
